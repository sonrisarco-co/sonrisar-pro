...
urlpatterns = [
    ...
    path("pacientes/<int:id>/finanzas/", views.patient_finances, name="patient_finances"),
    ...
    path(
        "pacientes/<int:patient_id>/odontograma/",
    ...
    path("agenda/no-asistio/<int:id>/", views.appointment_no_show, name="appointment_no_show"),
    path("agenda/asistio/<int:id>/", views.appointment_attended, name="appointment_attended"),
    ...
    path("budgets/<int:id>/add-adjustment/", views.budget_add_adjustment, name="budget_add_adjustment"),
    path("budgets/<int:id>/transfer-credit/", views.budget_transfer_credit, name="budget_transfer_credit"),
    ...
    path("whatsapp/iniciar-72h/", views.iniciar_recordatorios_72h, name="iniciar_recordatorios_72h"),
